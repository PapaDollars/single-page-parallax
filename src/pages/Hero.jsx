...
import backgroundImage from '../assets/images/heroSection.jpg';
    ...
    <section id="hero" className="relative overflow-hidden" style={{ height: '100vh' }}>
      ...
      <div className="relative z-10 flex items-center justify-center h-full w-full">
        <div className="container mx-auto text-center py-16">
          <h1 className="text-4xl md:text-6xl font-semibold mb-4 text-black">{title}</h1>
          <div className="max-w-3xl mx-auto">
            <h5 className="text-xl md:text-2xl font-light text-black mb-8">{subtitle}</h5>
          </div>
          <div>
            <a 
              href={buttonUrl} 
              className="bg-green-500 hover:bg-green-700 text-white font-medium py-3 px-8 rounded-md transition-colors duration-300"
            >
              {buttonText}
            </a>
          </div>
